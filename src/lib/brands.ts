...
export const brands = {
  ...
  academy: {
    ...
    description: "Clipzo Academy is a professional learning platform built for aspiring editors and creators. Powered by Clipzo’s real industry experience, the Academy focuses on practical editing skills, professional workflows, mentorship, and real project exposure. Learn with experience. Create with purpose. Grow with Clipzo.",
    cta: "Enroll now",
    room: "The classroom",
    logo: academyLogo,
    image: academyImage,
  ...
  studio: {
    ...
    description: "Clipzo Studio is a creative studio built around storytelling, visual production, and digital content. From photography, videography, podcast production, and creative storytelling to polished brand work, we build media experiences that feel cinematic, intentional, and memorable.",
    cta: "Book the studio",
    room: "The soundstage",
    logo: studioLogo,
    image: studioImage,
